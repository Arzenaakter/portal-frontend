...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex bg-(--background)">
      ...
      <div className="hidden lg:flex lg:w-1/2 xl:w-3/5 relative overflow-hidden flex-col justify-between p-12 bg-(--card) border-r border-(--border)">
        {/* Background glow */}
        <div className="absolute top-0 left-0 w-full h-full pointer-events-none bg-[radial-gradient(ellipse_at_30%_20%,rgba(232,255,71,0.07)_0%,transparent_60%)]" />
        <div className="absolute bottom-0 right-0 w-96 h-96 rounded-full blur-3xl pointer-events-none bg-[rgba(71,200,232,0.04)]" />

        {/* Center content */}
        <div className="relative z-10">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-semibold mb-8 bg-[rgba(232,255,71,0.08)] text-(--primary) border border-(--border)">
            <span className="w-1.5 h-1.5 rounded-full animate-pulse bg-(--primary)" />
            Admin Portal
          </div>

          <h1 className="text-5xl font-bold leading-[1.1] mb-6 font-display">
            Manage your
        ...
        {/* Bottom quote */}
        <div className="relative z-10 rounded-2xl p-5 bg-[rgba(255,255,255,0.03)] border border-(--border)">
          ...
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold bg-(--primary) text-(--foreground)">
              Y
            </div>
            <div>
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-md">
          ...
          {/* Heading */}
          <div className="mb-8">
            <h2 className="text-3xl font-bold mb- text-(--foreground) font-display">
              Welcome back
            </h2>
          ...
          >
            {/* Email */}
            <div>
              <label className="block text-xs font-semibold mb-2 uppercase tracking-wider font-display text-(--muted-foreground)">
                Email Address
              </label>
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <label className="block text-xs font-semibold uppercase tracking-wider text-(--muted-foreground) font-display">
                  Password
                </label>
                <button
                  type="button"
            ...
            <label className="flex items-center gap-3 cursor-pointer group">
              <div className="relative">
                ...
                <div className="w-4 h-4 rounded flex items-center justify-center transition-all peer-checked:opacity-100 border border-(--border) bg-(--input)">
                  <svg
                    width="10"
                    height="8"
                    viewBox="0 0 10 8"
          ...
          <Link
            href="/"
            className="flex items-center justify-center gap-2 w-full py-3.5 rounded-xl text-sm font-semibold transition-all hover:opacity-80 font-display text-(--muted-foreground) border  border-(--border)"
          >
            ← Back to Homepage
          </Link>
